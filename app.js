const WHATSAPP_NUMERO = "5511993808896"; // <-- troque pelo número real (com DDI+DDD, só números)
  ...
  return `
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a class="card-cta" href="${linkWhatsapp(p)}" target="_blank" rel="noopener">Pedir no WhatsApp</a>
      </div>
    </div>`;
}
...
const linkGeral = document.getElementById("whatsapp-link");
linkGeral.href = `https://wa.me/${WHATSAPP_NUMERO}?text=${encodeURIComponent(
  "Oi, quero fazer um pedido na Pirlimpinpins!"
)}`;
